...
use gearsoftware\behaviors\MultilingualSettingsBehavior;
use Yii;
...
class GeneralSettings extends BaseSettingsModel
{
    ...
    public function rules()
    {
        return ArrayHelper::merge(parent::rules(),
            [
                ...
                [['email'], 'email'],
                [['description'], 'safe'],
                ['title', 'default', 'value' => 'Site Title'],
	            ['timezone', 'default', 'value' => 'America/Tegucigalpa'],
                ['dateformat', 'default', 'value' => 'long'],
                ['timeformat', 'default', 'value' => 'h:mm a'],
            ]);
    }
    ...
    {
        return [
            'title' => Yii::t('core/settings', 'Site Title'),
            'description' => Yii::t('core/settings', 'Site Description'),
            'email' => Yii::t('core/settings', 'Admin Email'),
            'timezone' => Yii::t('core/settings', 'Timezone'),
            'dateformat' => Yii::t('core/settings', 'Date Format'),
            'timeformat' => Yii::t('core/settings', 'Time Format'),
        ];
    }
    ...
    public static function getTimezones()
    {
        return [
            ...
            "America/Tegucigalpa" => "(GMT-06:00) Tegucigalpa, Central America",
